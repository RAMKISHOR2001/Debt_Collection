...
def optimize():
    ...
    results = dict(results)
    result2 = prompt(trial["debt_amount"],trial["days_overdue"],date,results["Recommended Strategy"])
    result2 = {"email":result2}
    return render_template('test.html',data = results,data2 = result2)    
